...
function verifySigV4(req, res, next) {
  ...
  try {
    ...
    const incomingSig = headers.authorization || headers.Authorization;
...
async function start() {
  ...
  // SigV4 verification only on POST /graphql
  ...
  app.get(
    ...
    expressPlayground({
      endpoint: '/graphql',
      subscriptionEndpoint: `ws://localhost:${process.env.PORT || 4000}/graphql`,
    })
  );

  // Apollo GraphQL endpoint for POST /graphql
